...
| KLING 영상 변환 프롬프트 원문 | 2-second commercial opening shot, subtle push-in camera movement over a cluttered everyday desk and compact room, slight handheld shake to emphasize overwhelm, smartphone vibration, papers and small objects gently shifting, cinematic tension, busy morning feeling, futuristic city mood, neon blue and pink glow reflections, subtle cyberpunk lighting, stylish and readable composition, no app UI, no central interface, no face close-up |
