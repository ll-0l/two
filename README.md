...
| 사용 도구 및 목적 | ChatGPT 이미지 생성 또는 Ideogram에 공식 MODU 로고 이미지와 씬 1 레퍼런스 이미지를 함께 첨부해 키비주얼을 생성한다. KLING에서는 종이·포스트잇·홀로그램 카드가 스마트폰으로 흡수되는 모션을 적용한다. |
...
### 씬 2 ChatGPT·Ideogram 공용 이미지 생성 프롬프트
...
### 씬 3 ChatGPT·Ideogram 공용 이미지 생성 프롬프트
